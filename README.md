...
-   `DISCLAIMER.md`: shows the standard software disclaimer.
...
This software is preliminary or provisional and is subject to revision. Although the software has been subjected to rigorous review, the author(s) reserve the right to update the software as needed pursuant to further analysis and review. No warranty, expressed or implied, is made as to the functionality of the software and related material nor shall the fact of release constitute any such warranty. Furthermore, the software is released on the condition that the author(s) shall not be held liable for any damages resulting from its authorized or unauthorized use.
