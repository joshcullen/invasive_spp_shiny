...
#Example to get sheet id, where "[REST OF URL]" should be replaced by the Google Drive Spreadsheet ID (44 characters long)
sheet_id <- as_sheets_id("https://docs.google.com/spreadsheets/[REST OF URL]")
